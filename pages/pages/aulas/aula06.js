                ...
                <div className="row">
                  ...
                  <div className="col-xl-6">
                    <div className="card m-3">
                      <div className="card-body">
                        <div className={styleEstilo.cinza}>
                          <h4 className="text-white p-2 text-center" id={1}>Porta Lógica Not (Não)</h4>
                        </div>
                        <p className="m-3" style={{textAlign: 'justify'}}>Essa porta retorna falso quando a entrada for verdadeira e retorna verdadeira quando a entrada for falsa. Segue exemplo das entradas A e B e sua respectiva saída R: </p>
                        <div className="container">
                          <table className={styleTab.tabelaClara}>
                            <tbody>
                              <tr>
